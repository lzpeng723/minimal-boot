...
<script>
import { get${simpleClassName}Page, get${simpleClassName}Dict, delete${simpleClassName}, batchOperation } from '@/api/${moduleName}/${simpleClassName?uncap_first}' // ${chineseClassName}api<#if editPageType=="dialog">
