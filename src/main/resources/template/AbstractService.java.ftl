...
import com.lzpeng.project.${moduleName}.repository.${simpleClassName}Repository;
...
public abstract class Abstract${simpleClassName}Service extends ${entityType}ServiceImpl<${simpleClassName}> {

    protected static final String ENTITY_NAME = "${fullClassName}";

    protected ${simpleClassName}Repository ${simpleClassName?uncap_first}Repository;
